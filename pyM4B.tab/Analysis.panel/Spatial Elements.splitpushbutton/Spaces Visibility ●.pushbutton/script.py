...
__doc__ = "Enable Temporary View Properties and then turn ON visibility for "\
			"Spaces and its sub-categories, including Separators Lines.\n"\
...
def turn_categories_on():
	space_cat = DB.Category.GetCategory(doc, BIC.OST_MEPSpaces)
	subCat = list(space_cat.SubCategories)
	categories = [space_cat,
